				...
				<div className="py-4 px-4 bg-gray-50 rounded-lg">
					...
					<div className="hidden min-[600px]:flex items-center justify-center">
						<div className="flex items-center space-x-4">
							...
							<div className="text-center">
								...
								<span
									className={`text-xs ${driver.status === "completed" ? "text-[#0E4663] font-medium" : "text-gray-600"}`}
								>
									drop off
								</span>
							</div>
					...
					<div className="min-[600px]:hidden flex flex-col items-start space-y-3">
						...
						<div className="flex items-center w-full">
							...
							<span
								className={`text-xs ml-3 ${driver.status === "completed" ? "text-[#0E4663] font-medium" : "text-gray-600"}`}
							>
								drop off
							</span>
						</div>
