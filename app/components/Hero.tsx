			...
			<div className="flex flex-col lg:flex-row lg:justify-around">
				<div className="lg:w-1/2 lg:flex lg:flex-col lg:items-start lg:justify-center  mt-5">
					...
					<p className="mt-7 text-slate-600 px-10 lg:px-0 lg:text-left">
						From campus to clinics to late-night rides home, our drivers arrive
						fast and drive with care.
					</p>
					<div className="mt-10 flex flex-col lg:flex-row items-center gap-3">
						<Link
							href="/login"
							className="w-40 rounded-xl bg-slate-700 px-5 py-2 text-center text-white hover:bg-slate-800"
						>
							Sign in
						</Link>
						<Link
