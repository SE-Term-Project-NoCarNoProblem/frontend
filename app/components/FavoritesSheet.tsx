...
export default function FavoritesSheet({
	...
	const [tab, setTab] = useState<'pickup' | 'dropoff'>(target === 'dest' ? 'dropoff' : 'pickup')
	useEffect(() => {
	...
	const pickupFavorites = [
		...
		{ name: "Chulalongkorn University", lat: 13.738, lng: 100.532, distance: "2.1 km" },
	...
	const dropoffFavorites = [
		...
		{ name: "ICONSIAM", lat: 13.726, lng: 100.510, distance: "5.8 km" },
	]
        ...
        "
			...
			>
				...
				<div className="mx-auto w-full max-w-3xl px-4">
					{/* Tabs */}
					<div className="pt-3">
						<div className="flex gap-2 justify-center">  {/* centered tabs */}
							<button
