    ...
    >
      ...
      >
        <div className="p-6 sm:p-8">
          <div className={`mx-auto mb-4 grid h-32 w-32 place-items-center rounded-full`}>
            <Image src={theme.icon} alt="caution red" width={200} height={200} />
          </div>

          <h2 id="account-status-title" className="text-center text-2xl font-extrabold  text-[#0E4663]">
            {theme.heading}
          </h2>
          <p className="mt-1 text-center text-lg font-semibold  text-[#0E4663]">{theme.subheading}</p>
          <div id="account-status-desc" className="mt-3 text-base leading-7  text-[#0E4663]">
            {theme.body}
          </div>
